...
<div id="switcher">
<a style="" id="go-login" href="<?php echo $base . '/index.php/account/login/';?>">登录</a>
</div>
<form autocomplete="off" method="POST" action="<?php echo $base . '/index.php/account/register/';?>" class="clearfix" id="reg-form">
...
<input type="submit" value="注册" class="input-button" id="reg-submit"></form>
</div>
...
$(document).ready(function(){
	   $("#go-login").click(function(){
	     ...
	     window.location.href = "<?php echo $base . '/index.php/account/login/';?>";
	   });
	});
</script>
